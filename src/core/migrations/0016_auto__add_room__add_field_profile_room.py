...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_room', (
            ...
            ('floor', self.gf('django.db.models.fields.CharField')(default=u'-', max_length=200)),
            ('title', self.gf('django.db.models.fields.CharField')(default=u'-', max_length=200)),
            ('capacity', self.gf('django.db.models.fields.PositiveIntegerField')(default=2)),
            ('current', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('core', ['Room'])

        # Adding field 'Profile.room'
        db.add_column('core_profile', 'room',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Room'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.room'
        db.delete_column('core_profile', 'room_id')
