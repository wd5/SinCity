...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RoleSection'
        db.create_table('core_rolesection', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=100)),
        ))
        db.send_create_signal('core', ['RoleSection'])

        # Adding field 'Role.rolesection'
        db.add_column('core_role', 'rolesection', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['core.RoleSection']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RoleSection'
        db.delete_table('core_rolesection')

        # Deleting field 'Role.rolesection'
        db.delete_column('core_role', 'rolesection_id')
    ...
    models = {
        ...
        'core.role': {
            ...
            'section': ('django.db.models.fields.CharField', [], {'default': "'other'", 'max_length': '20'})
        },
        'core.roleconnection': {
