...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.redirect'
        db.add_column('core_article', 'redirect',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Article.path'
        db.add_column('core_article', 'path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Article.redirect'
        db.delete_column('core_article', 'redirect')

        # Deleting field 'Article.path'
        db.delete_column('core_article', 'path')
