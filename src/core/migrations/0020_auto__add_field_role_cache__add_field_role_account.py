...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.cache'
        db.add_column('core_role', 'cache',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Role.account'
        db.add_column('core_role', 'account',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Role.cache'
        db.delete_column('core_role', 'cache')

        # Deleting field 'Role.account'
        db.delete_column('core_role', 'account')
    ...
    models = {
        ...
        'core.role': {
            ...
            'cache': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
