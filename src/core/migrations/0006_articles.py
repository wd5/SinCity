...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        articles = ([1, None, u'О проекте', u'Содержание', 10],
                    [2, None, u'Правила', u'Содержание', 20],
                    [3, 2, u'Агрессивные действия', u'Содержание', 30],
                    [4, 2, u'Медицина', u'Содержание', 40],
                    [5, 2, u'О техническом прогрессе', u'Содержание', 50],
                    [6, 2, u'Общие моменты', u'Содержание', 60],
                    [7, 2, u'Правила по полиции', u'Содержание', 70],
                    [8, 2, u'Секс на игре', u'Содержание', 80],
                    [9, 2, u'Смерть', u'Содержание', 90],
                    [10, None, u'Статьи', u'Содержание', 100],
                    [11, 10, u'О супергероях и суперзлодеях', u'Содержание', 110],
                    [12, 10, u'О костюмах супергероев', u'Содержание', 120],
                    [13, 10, u'О персонажах', u'Содержание', 130],
                    [14, None, u'Технические подробности', u'Содержание', 140],
                )

        for article in articles:
            article[1] = orm.Article.objects.get(pk=article[1]) if article[1] else None
            orm.Article.objects.create(**dict(zip(('id', 'parent', 'title', 'content', 'order'), article)))
