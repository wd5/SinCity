...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_news', 'date_created', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'News.date_created'
        db.alter_column('core_news', 'date_created', self.gf('django.db.models.fields.DateTimeField')(null=True))
