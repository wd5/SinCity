...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.Profile.objects.filter(pk=36).update(portrait='http://img-fotki.yandex.ru/get/6003/19044756.104/0_84069_65e0b9e0_orig')
        orm.Profile.objects.filter(pk=39).update(portrait='http://img-fotki.yandex.ru/get/6205/19044756.104/0_8406a_fc66f59c_orig')
