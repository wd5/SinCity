...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Role.section'
        db.add_column('core_role', 'section', self.gf('django.db.models.fields.CharField')(default='other', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Role.section'
        db.delete_column('core_role', 'section')
