...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        roles = (['policy', u'Шеф полиции', u'-'],
                 ['policy', u'Криминалист', u'Кэтрин Уиллоуз'],
                 ['policy', u'Сержант полиции', u'Диана Макбет'],
                 ['policy', u'-', u'Люсиль'],
                 ['policy', u'детектив', u'Анджела Додсон'],
                 ['policy', u'детектив отдела нераскрытых преступлений', u'Макс Пейн'],
                 ['med', u'хирург', u'Харон Мортис'],
                 ['med', u'патологоанатом', u'Виктория Бэкхем'],
                 ['med', u'Психиатр', u'-'],
                 ['med', u'Медсестра', u'-'],
                 ['med', u'Пластический хирург', u'-'],
                 ['politics', u'-', u'Сенатор Рорк'],
                 ['politics', u'-', u'Рорк младши'],
                 ['politics', u'миллионер, промышленник', u'Уэсли Доддс'],
                 ['politics', u'-', u'Джокер'],
                 ['religion', u'Кардинал Патрик', u'Генри Рорк'],
                 ['religion', u'-', u'Кевин'],
                 ['jounalist', u'Главный редактор газеты Daily Bugle', u'-'],
                 ['jounalist', u'журналист Daily Bugle', u'Спайдер Иерусалим'],
                 ['jounalist', u'Журналистка газеты Daily Bugle', u'-'],
                 ['porn', u'бордельмаман', u'Гейл'],
                 ['porn', u'-', u'Голди/Венди'],
                 ['porn', u'-', u'Даллас'],
                 ['porn', u'-', u'Дуайт МакКарти'],
                 ['other', u'-', u'Меченый'],
                 ['other', u'чистильщик обуви', u'Анри Линож'],
                 ['other', u'-', u'Гай Фокс'],
                 ['other', u'Частный детектив', u'-'],
                 ['other', u'Электра', u'-'],
                 ['other', u'-', u'Джон Константин'],
                 ['other', u'-', u'Э.Нигма'],
                 ['other', u'-', u'Уолтер Ковач'],
        )

        for number, role in enumerate(roles):
            role.append(number)
            orm.Role.objects.create(**dict(zip(('section', 'profession', 'name', 'order'), role)))
